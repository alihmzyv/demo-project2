...
public class Condition {
    public static org.jooq.Condition AGENT_IS_DELETED = AGENT.STATUS.eq((short) 3);
    public static org.jooq.Condition AGENT_IS_NOT_DELETED = AGENT_IS_DELETED.isFalse();
    public static org.jooq.Condition CASHIER_IS_DELETED = CASHIER.STATUS.eq((short) 3);
    public static org.jooq.Condition AGENT_ACTIVE = AGENT.STATUS.eq((short) 1);
    public static org.jooq.Condition AGENT_INACTIVE = AGENT.STATUS.eq((short) 2);
    public static org.jooq.Condition CASHIER_ACTIVE = CASHIER.STATUS.eq((short) 1);
    public static org.jooq.Condition CASHIER_INACTIVE = CASHIER.STATUS.eq((short) 2);
